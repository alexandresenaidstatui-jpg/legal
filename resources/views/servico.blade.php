                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="nome"
                                    placeholder="Digite seu nome completo ou nome da empresa" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="tel" class="form-control" id="contato" placeholder="(11) 99999-9999"
                                    required>
                            </div>
                        </div>
                            ...
                            <div class="row-selects">
                                <div class="state-select">
                                    <div class="input-group">
                                        ...
                                        <select class="form-select" id="2" required>
                                ...
                                <div class="city-select">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="1" placeholder="Cidade" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                ...
                                <textarea class="form-control" id="descricão"
                        ...
                        <div class="col-12">
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <button type="button" class="btn btn-gold" id="meu4">
