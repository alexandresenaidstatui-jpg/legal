                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="nome" value="{{$servico->nome}}" placeholder="Digite seu nome completo ou nome da empresa" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="tel" class="form-control" value="{{$servico->contato}}" id="contato" placeholder="(11) 99999-9999"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select" value="{{$servico->tipo}}" id="tipo" required>
                            ...
                            <div class="row-selects">
                                <div class="city-select">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control"value="{{$servico->cidade}}" id="cidade" placeholder="Cidade" required>
                                    </div>
                                </div>
                            </div>
                        </div>
